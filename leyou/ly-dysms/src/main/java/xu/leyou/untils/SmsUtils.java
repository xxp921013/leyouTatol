...
public class SmsUtils {
    ...
    public SendSmsResponse sendSms(String phone, String templateParam, String signName, String template) throws ClientException {
        //验证手机号验证码时间,防止短时间重复发出
        String lastTime = srt.opsForValue().get(KEY_PREFIX + phone);
        ...
        //短信发出后,写入redis,并设置生存时间,到时删除
        srt.opsForValue().set(KEY_PREFIX + phone, String.valueOf(System.currentTimeMillis()), 1, TimeUnit.MINUTES);
